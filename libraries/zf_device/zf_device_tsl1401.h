...
#define TSL1401_AO_PIN          (ADC1_CH0_B27)                                  // 对应第一个 TSL1401 的 AO 引脚
#define TSL1401_AO_PIN2         (ADC1_CH1_B12)                                  // 对应第二个 TSL1401 的 AO 引脚
...
#define TSL1401_PIT_INDEX       (PIT_CH3)                                       // 使用周期中断
