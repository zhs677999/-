...
// 速度分段控制
#define STRAIGHT_DEAD_ZONE_DEG      (3.5f)   // 直道死区，舵机偏差小于该角度时视为直道
#define STRAIGHT_SPEED_DUTY         (30)     // 直道目标 duty
#define CURVE_SPEED_DUTY            (22)     // 弯道目标 duty
#define ROUNDABOUT_SPEED_DUTY       (19)     // 环岛、终点等复杂场景的限速
